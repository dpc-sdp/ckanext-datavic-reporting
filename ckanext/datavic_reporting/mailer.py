...
def _mail_recipient(recipient_name, recipient_email,
                    ...
                    body, body_html=None, headers=None, attachments=[]):
...
def mail_recipient(recipient_name, recipient_email, subject,
                   body, body_html=None, headers={}, attachments = []):
    '''Sends an email'''
...
def mail_user(recipient, subject, body, body_html=None, headers={}, attachments=[]):
...
def send_scheduled_report_email(user_emails, email_type, extra_vars):
    ...
    for user_email in user_emails:
        try:
            ...
            log.error(u'Failed to send scheduled report email to %s.', user_email, exc_info=1)